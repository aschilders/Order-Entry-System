...
public class menuTypeUpdateForm extends JFrame {
	// GRID FORMATTING
	private final int GRIDWIDTH 	= 900;		// size our grid 
	private final int GRIDHEIGHT	= 300;


	menuTypeUpdatePanelBuilder userInfoPanel;		// panel for user information
	...
	public menuTypeUpdateForm() throws SQLException {
		// set the window title
		setTitle("Update Menu Types");
		// set our action when the user close
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		
		// create a panel builder object
		userInfoPanel = new menuTypeUpdatePanelBuilder();
	...
	private void buildListPanel() throws SQLException {
		...
		listPanel.setBorder(BorderFactory.createTitledBorder("Menu Type Information"));
		
		// create an object to access the db
		menuTypeTableManager um = new menuTypeTableManager();
				...
				public void valueChanged(ListSelectionEvent event) {
					...
					if (ourTable.getSelectedRow() >= 0) {
						...
						try {
							...
							ResultSet updateInfo = menuTypeTableManager.selectUpdate(selectedRecordID);

							while(updateInfo.next()) {
								userInfoPanel.setMenuType(updateInfo.getString("Category"));
							}
	...
	private void resetForm() throws SQLException {
		...
		searchInfo = menuTypeTableManager.selectUsers("");
	...
	// Handle search, filter button
		public class SearchButtonListener implements ActionListener {
			...
			public void actionPerformed(ActionEvent e1) {
				...
				String strCategory = userInfoPanel.getMenuType();
				...
				try {
					...
					menuTypeTableManager getInfo = new menuTypeTableManager();
					// create a blank search of the table
					searchInfo = menuTypeTableManager.selectUsers(strCategory);
	...
	public class InsertButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			try {
				...
				menuTypeTableManager userManager = new menuTypeTableManager();
				
				// insert the record
				rows = userManager.insertRecord(strCategory);
	...
	public class UpdateButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e1) {
			...
			int rows = 0;
			menuTypeTableManager updater;
			
			
			try {
				// create an object to instantiate the Connection to the table	
				updater = new menuTypeTableManager();
				rows = updater.updateRecord(strCategory, selectedRecordID);
	...
	public class DeleteButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e1) {
			...
			int rows = 0;
			menuTypeTableManager Deleter;
			
			
			try {
				// create an object to instantiate the Connection to the table	
				Deleter = new menuTypeTableManager();
	...
	public static void main(String[] arg0) throws SQLException {
		menuTypeUpdateForm dbgs = new menuTypeUpdateForm();
	}
}
