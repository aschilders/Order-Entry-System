...
public class employeeUpdateForm extends JFrame {
	...
	employeeUpdatePanelBuilder userInfoPanel;		// panel for user information
	...
	public employeeUpdateForm() throws SQLException {
		...
		userInfoPanel = new employeeUpdatePanelBuilder();
	...
	private void buildListPanel() throws SQLException {
		...
		listPanel.setBorder(BorderFactory.createTitledBorder("Employee Information"));
					...
					if (ourTable.getSelectedRow() >= 0) {
						...
						try {
							...
							while(updateInfo.next()) {
								...
								userInfoPanel.setCombo(updateInfo.getInt("Permission"));
							}
	...
	private void resetForm() throws SQLException {
		...
		searchInfo = employeeTableManager.selectUsers("", "", "", "", "", "", "", "", "");
		...
		public class SearchButtonListener implements ActionListener {
			...
			public void actionPerformed(ActionEvent e1) {
				...
				try {
					...
					employeeTableManager getInfo = new employeeTableManager();
					// create a blank search of the table
					searchInfo = employeeTableManager.selectUsers(strFirst, strLast, strPhone, strAddress, strState, strZip, strEmail, strPassword, strCombo);
	...
	public class InsertButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			try {
				...
				employeeTableManager userManager = new employeeTableManager();
				
				// insert the record
				rows = userManager.insertRecord(strFirst, strLast, strPhone, strAddress, strState, strZip, strEmail, strPassword, strCombo);
	...
	public class UpdateButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e1) {
			...
			try {
				...
				rows = updater.updateRecord(strFirst, strLast, strPhone, strAddress, strState, strZip, strEmail, strPassword, strCombo, selectedRecordID);
	...
	public static void main(String[] arg0) throws SQLException {
		employeeUpdateForm dbgs = new employeeUpdateForm();
	}
}
