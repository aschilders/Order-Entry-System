...
public class userPositionsManager {

   // Create a named constant for the URL.
   // NOTE: This value is specific for Java DB
   public final String DB_URL = 
                "jdbc:ucanaccess://restaurant.accdb";
   ...
   public userPositionsManager() throws SQLException
   {
   ...
   public static ResultSet selectPositions() throws SQLException
   {
	   ...
	   String ourSQLSelect = "SELECT * from categories";  
